...
<meta name="description" content="根据转载：粉丝日志修改
Hexo介绍&amp;emsp;&amp;emsp;Hexo是一个简单的、轻量的、基于Node的一个静态博客框架。通过Hexo我们可以快速创建自己的博客，仅需要几条命令就可以完成。发布时，Hexo可以部署在自己的Node服务器上面，也可以部署github上面。对于个人用户来说，部署在github上好处颇多，不仅可以省去服务器的成本，还可以减少各种系统运维的麻烦事(系统管理、备份、网络)。所">
<meta property="og:type" content="article">
<meta property="og:title" content="用Hexo与Github打造属于自己的博客">
<meta property="og:url" content="http://www.dongxiaoxia.xyz/2015/08/02/hexo001/index.html">
<meta property="og:site_name" content="Hello World">
<meta property="og:description" content="根据转载：粉丝日志修改
Hexo介绍&amp;emsp;&amp;emsp;Hexo是一个简单的、轻量的、基于Node的一个静态博客框架。通过Hexo我们可以快速创建自己的博客，仅需要几条命令就可以完成。发布时，Hexo可以部署在自己的Node服务器上面，也可以部署github上面。对于个人用户来说，部署在github上好处颇多，不仅可以省去服务器的成本，还可以减少各种系统运维的麻烦事(系统管理、备份、网络)。所">
<meta property="og:updated_time" content="2016-04-22T16:27:06.591Z">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="用Hexo与Github打造属于自己的博客">
<meta name="twitter:description" content="根据转载：粉丝日志修改
Hexo介绍&amp;emsp;&amp;emsp;Hexo是一个简单的、轻量的、基于Node的一个静态博客框架。通过Hexo我们可以快速创建自己的博客，仅需要几条命令就可以完成。发布时，Hexo可以部署在自己的Node服务器上面，也可以部署github上面。对于个人用户来说，部署在github上好处颇多，不仅可以省去服务器的成本，还可以减少各种系统运维的麻烦事(系统管理、备份、网络)。所">
...
<script type="text/javascript" id="hexo.configuration">
  ...
  <title> 用Hexo与Github打造属于自己的博客 | Hello World </title>
</head>
...
<nav class="site-nav">
  ...
  <article class="post post-type-normal " itemscope itemtype="http://schema.org/Article">
    ...
    <div class="post-body" itemprop="articleBody">
        ...
        <p>根据转载：<a href="http://blog.fens.me/hexo-blog-github/" title="粉丝日志" target="_blank">粉丝日志</a>修改</p>
...
<div style="padding: 10px 0; margin: 20px auto; width: 90%; text-align: center">
  ...
  <div id="QR" style="display: none;">
    ...
    <footer class="post-footer">
        ...
        <div class="post-nav">
          ...
          <div class="post-nav-prev post-nav-item">
              ...
              <a href="/2015/08/15/hexo-writing/" rel="prev" title="Markdown写作常用语法">
                Markdown写作常用语法 <i class="fa fa-chevron-right"></i>
              </a>
    ...
    <div class="post-spread">
        ...
        <div class="ds-share flat" data-thread-key="2015/08/02/hexo001/"
     data-title="用Hexo与Github打造属于自己的博客"
     data-content=""
     data-url="http://www.dongxiaoxia.xyz/2015/08/02/hexo001/">
  ...
  <div class="comments" id="comments">
      ...
      <div class="ds-thread" data-thread-key="2015/08/02/hexo001/"
           data-title="用Hexo与Github打造属于自己的博客" data-url="http://www.dongxiaoxia.xyz/2015/08/02/hexo001/">
      </div>
      ...
      <section class="site-overview sidebar-panel ">
        ...
        <section class="post-toc-wrap motion-element sidebar-panel sidebar-panel-active">
          <div class="post-toc">
              ...
              <div class="post-toc-content"><ol class="nav"><li class="nav-item nav-level-2"><a class="nav-link" href="#Hexo介绍"><span class="nav-number">1.</span> <span class="nav-text">Hexo介绍</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Hexo安装"><span class="nav-number">2.</span> <span class="nav-text">Hexo安装</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#安装Git"><span class="nav-number">2.1.</span> <span class="nav-text">安装Git</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#安装node-js"><span class="nav-number">2.2.</span> <span class="nav-text">安装node.js</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#安装Hexo"><span class="nav-number">2.3.</span> <span class="nav-text">安装Hexo</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#Hexo使用"><span class="nav-number">3.</span> <span class="nav-text">Hexo使用</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#部署Hexo到github"><span class="nav-number">4.</span> <span class="nav-text">部署Hexo到github</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#配置Git"><span class="nav-number">4.1.</span> <span class="nav-text">配置Git</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#部署到github"><span class="nav-number">4.2.</span> <span class="nav-text">部署到github</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#绑定域名"><span class="nav-number">5.</span> <span class="nav-text">绑定域名</span></a></li></ol></div>

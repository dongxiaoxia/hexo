...
<meta name="description" content="google了一个下午，暂时找到两种解决办法，虽然这两种方法都不是很方便，暂时先这么用着吧！
1.全部参数封装为一个对象controller类1234567891011121314151617/** * 批量新增用户 * * 不能直接传List  &amp;lt; Map&amp;gt; 数组对象，只能用两个法子传参数，一个是把数组对象在前端变为String传到后台再解析，另外一个就是把所有参数封装成一个对象，前">
<meta property="og:type" content="article">
<meta property="og:title" content="SpringMVC Controller接收List< Map>或List< Object>">
<meta property="og:url" content="http://www.dongxiaoxia.xyz/2015/12/23/spring00001/index.html">
<meta property="og:site_name" content="Hello World">
<meta property="og:description" content="google了一个下午，暂时找到两种解决办法，虽然这两种方法都不是很方便，暂时先这么用着吧！
1.全部参数封装为一个对象controller类1234567891011121314151617/** * 批量新增用户 * * 不能直接传List  &amp;lt; Map&amp;gt; 数组对象，只能用两个法子传参数，一个是把数组对象在前端变为String传到后台再解析，另外一个就是把所有参数封装成一个对象，前">
<meta property="og:updated_time" content="2016-04-22T16:27:06.576Z">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="SpringMVC Controller接收List< Map>或List< Object>">
<meta name="twitter:description" content="google了一个下午，暂时找到两种解决办法，虽然这两种方法都不是很方便，暂时先这么用着吧！
1.全部参数封装为一个对象controller类1234567891011121314151617/** * 批量新增用户 * * 不能直接传List  &amp;lt; Map&amp;gt; 数组对象，只能用两个法子传参数，一个是把数组对象在前端变为String传到后台再解析，另外一个就是把所有参数封装成一个对象，前">
...
<script type="text/javascript" id="hexo.configuration">
  ...
  <title> SpringMVC Controller接收List< Map>或List< Object> | Hello World </title>
</head>
...
<nav class="site-nav">
  ...
  <article class="post post-type-normal " itemscope itemtype="http://schema.org/Article">
    ...
    <div class="post-body" itemprop="articleBody">
        ...
        <p>google了一个下午，暂时找到两种解决办法，虽然这两种方法都不是很方便，暂时先这么用着吧！</p>
<h2 id="1-全部参数封装为一个对象">1.全部参数封装为一个对象</h2><h3 id="controller类">controller类</h3><figure class="highlight java"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br><span class="line">10</span><br><span class="line">11</span><br><span class="line">12</span><br><span class="line">13</span><br><span class="line">14</span><br><span class="line">15</span><br><span class="line">16</span><br><span class="line">17</span><br></pre></td><td class="code"><pre><span class="line"><span class="comment">/**</span><br><span class="line"> * 批量新增用户</span><br><span class="line"> *</span><br><span class="line"> * 不能直接传List  &lt; Map&gt; 数组对象，只能用两个法子传参数，一个是把数组对象在前端变为String传到后台再解析，另外一个就是把所有参数封装成一个对象，前端JSON.stringify(params)后变为字符串传到后台，后台会自动转换为对象</span><br><span class="line"> *</span><br><span class="line"> * <span class="doctag">@param</span> batchCreateVO 封装好的对象</span><br><span class="line"> * <span class="doctag">@param</span> request</span><br><span class="line"> * <span class="doctag">@param</span> session</span><br><span class="line"> * <span class="doctag">@return</span></span><br><span class="line"> */</span></span><br><span class="line"><span class="annotation">@RequestMapping</span>(value = <span class="string">"/batchCreate"</span>, produces = MediaTypes.JSON_UTF_8)</span><br><span class="line"><span class="annotation">@ResponseBody</span></span><br><span class="line"><span class="function"><span class="keyword">protected</span> String <span class="title">batchCreate</span><span class="params">(</span><br><span class="line">        @RequestBody BatchCreateVO batchCreateVO,</span><br><span class="line">        HttpServletRequest request, HttpSession session)</span> </span>&#123;</span><br><span class="line">        <span class="comment">//dosomething</span></span><br><span class="line">	&#125;</span><br></pre></td></tr></table></figure>
...
<div style="padding: 10px 0; margin: 20px auto; width: 90%; text-align: center">
  ...
  <div id="QR" style="display: none;">
    ...
    <footer class="post-footer">
        ...
        <div class="post-nav">
          <div class="post-nav-next post-nav-item">
              ...
              <a href="/2015/08/19/hexo001/" rel="next" title="网站后台页面左侧收缩折叠效果">
                <i class="fa fa-chevron-left"></i> 网站后台页面左侧收缩折叠效果
              </a>
          ...
          <div class="post-nav-prev post-nav-item">
              ...
              <a href="/2015/12/23/java00001/" rel="prev" title="Date、String、Calendar三种时间类型的转换">
                Date、String、Calendar三种时间类型的转换 <i class="fa fa-chevron-right"></i>
              </a>
    ...
    <div class="post-spread">
        ...
        <div class="ds-share flat" data-thread-key="2015/12/23/spring00001/"
     data-title="SpringMVC Controller接收List< Map>或List< Object>"
     data-content=""
     data-url="http://www.dongxiaoxia.xyz/2015/12/23/spring00001/">
  ...
  <div class="comments" id="comments">
      ...
      <div class="ds-thread" data-thread-key="2015/12/23/spring00001/"
           data-title="SpringMVC Controller接收List< Map>或List< Object>" data-url="http://www.dongxiaoxia.xyz/2015/12/23/spring00001/">
      </div>
      ...
      <section class="site-overview sidebar-panel ">
        ...
        <section class="post-toc-wrap motion-element sidebar-panel sidebar-panel-active">
          <div class="post-toc">
              ...
              <div class="post-toc-content"><ol class="nav"><li class="nav-item nav-level-2"><a class="nav-link" href="#1-全部参数封装为一个对象"><span class="nav-number">1.</span> <span class="nav-text">1.全部参数封装为一个对象</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#controller类"><span class="nav-number">1.1.</span> <span class="nav-text">controller类</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#封装的对象"><span class="nav-number">1.2.</span> <span class="nav-text">封装的对象</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#页面请求"><span class="nav-number">1.3.</span> <span class="nav-text">页面请求</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#2-单独转换需要的List"><span class="nav-number">2.</span> <span class="nav-text">2.单独转换需要的List</span></a></li></ol></div>

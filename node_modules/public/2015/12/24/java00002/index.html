...
<meta name="description" content="来自 CDSN博客 java那些事

  想要成为合格的Java程序员或工程师到底需要具备哪些专业技能，面试者在面试之前到底需要准备哪些东西呢？本文陈列的这些内容既可以作为个人简历中的内容，也可以作为面试的时候跟面试官聊的东西，你可以把这些内容写到你的简历中，当然更需要的是你在面试的时候向面试官展示这些专业技能。相信此文对正在寻觅Java程序员（Java工程师）职位的freshman以及希望成为中">
<meta property="og:type" content="article">
<meta property="og:title" content="Java程序员的就业指导">
<meta property="og:url" content="http://www.dongxiaoxia.xyz/2015/12/24/java00002/index.html">
<meta property="og:site_name" content="Hello World">
<meta property="og:description" content="来自 CDSN博客 java那些事

  想要成为合格的Java程序员或工程师到底需要具备哪些专业技能，面试者在面试之前到底需要准备哪些东西呢？本文陈列的这些内容既可以作为个人简历中的内容，也可以作为面试的时候跟面试官聊的东西，你可以把这些内容写到你的简历中，当然更需要的是你在面试的时候向面试官展示这些专业技能。相信此文对正在寻觅Java程序员（Java工程师）职位的freshman以及希望成为中">
<meta property="og:updated_time" content="2016-04-22T16:27:06.576Z">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Java程序员的就业指导">
<meta name="twitter:description" content="来自 CDSN博客 java那些事
...
<script type="text/javascript" id="hexo.configuration">
  ...
  <title> Java程序员的就业指导 | Hello World </title>
</head>
...
<div style="padding: 10px 0; margin: 20px auto; width: 90%; text-align: center">
  ...
  <div id="QR" style="display: none;">
    ...
    <footer class="post-footer">
        ...
        <div class="post-nav">
          <div class="post-nav-next post-nav-item">
              ...
              <a href="/2015/12/23/java00001/" rel="next" title="Date、String、Calendar三种时间类型的转换">
                <i class="fa fa-chevron-left"></i> Date、String、Calendar三种时间类型的转换
              </a>
          ...
          <div class="post-nav-prev post-nav-item">
              ...
              <a href="/2015/12/24/java00003/" rel="prev" title="如何成为一个牛掰的Java大神">
                如何成为一个牛掰的Java大神 <i class="fa fa-chevron-right"></i>
              </a>
    ...
    <div class="post-spread">
        ...
        <div class="ds-share flat" data-thread-key="2015/12/24/java00002/"
     data-title="Java程序员的就业指导"
     data-content=""
     data-url="http://www.dongxiaoxia.xyz/2015/12/24/java00002/">
  ...
  <div class="comments" id="comments">
      ...
      <div class="ds-thread" data-thread-key="2015/12/24/java00002/"
           data-title="Java程序员的就业指导" data-url="http://www.dongxiaoxia.xyz/2015/12/24/java00002/">
      </div>
      ...
      <section class="site-overview sidebar-panel ">
        ...
        <section class="post-toc-wrap motion-element sidebar-panel sidebar-panel-active">
          <div class="post-toc">
              ...
              <div class="post-toc-content"><ol class="nav"><li class="nav-item nav-level-4"><a class="nav-link" href="#专业技能"><span class="nav-number">1.</span> <span class="nav-text">专业技能</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#项目介绍"><span class="nav-number">2.</span> <span class="nav-text">项目介绍</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#项目开发流程"><span class="nav-number">3.</span> <span class="nav-text">项目开发流程</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#测试_>>>_测试报告_/_缺陷报告"><span class="nav-number">4.</span> <span class="nav-text">测试 >>> 测试报告 / 缺陷报告</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#交付和维护_>>>_用户手册_/_操作手册"><span class="nav-number">5.</span> <span class="nav-text">交付和维护 >>> 用户手册 / 操作手册</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#项目管理"><span class="nav-number">6.</span> <span class="nav-text">项目管理</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#应用服务器："><span class="nav-number">7.</span> <span class="nav-text">应用服务器：</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#第三方工具（插件）应用"><span class="nav-number">8.</span> <span class="nav-text">第三方工具（插件）应用</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#面试提问"><span class="nav-number">9.</span> <span class="nav-text">面试提问</span></a></li></ol></li><li class="nav-item nav-level-3"><a class="nav-link" href="#其他"><span class="nav-number"></span> <span class="nav-text">其他</span></a><ol class="nav-child"><li class="nav-item nav-level-4"><a class="nav-link" href="#常见错误"><span class="nav-number">1.</span> <span class="nav-text">常见错误</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#面试时可以反问面试官的问题"><span class="nav-number">2.</span> <span class="nav-text">面试时可以反问面试官的问题</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#S-A-R-法则"><span class="nav-number">3.</span> <span class="nav-text">S.A.R.法则</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#算法题的五种解法"><span class="nav-number">4.</span> <span class="nav-text">算法题的五种解法</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#录用谈判"><span class="nav-number">5.</span> <span class="nav-text">录用谈判</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#自我评价"><span class="nav-number">6.</span> <span class="nav-text">自我评价</span></a></li></ol></div>

...
<meta name="description" content="来自：HollisChuang’s Blog
链接：http://www.hollischuang.com/archives/489

一、基础篇1.1 JVM1.1.1. Java内存模型，Java内存管理，Java堆和栈，垃圾回收
http://www.jcp.org/en/jsr/detail?id=133
http://ifeve.com/jmm-faq/

1.1.2. 了解JVM各种参">
<meta property="og:type" content="article">
<meta property="og:title" content="如何成为一个牛掰的Java大神">
<meta property="og:url" content="http://www.dongxiaoxia.xyz/2015/12/24/java00003/index.html">
<meta property="og:site_name" content="Hello World">
<meta property="og:description" content="来自：HollisChuang’s Blog
链接：http://www.hollischuang.com/archives/489
...
1.1.2. 了解JVM各种参">
<meta property="og:updated_time" content="2016-04-22T16:27:06.591Z">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="如何成为一个牛掰的Java大神">
<meta name="twitter:description" content="来自：HollisChuang’s Blog
链接：http://www.hollischuang.com/archives/489
...
<script type="text/javascript" id="hexo.configuration">
  ...
  <title> 如何成为一个牛掰的Java大神 | Hello World </title>
</head>
      ...
      <header class="post-header">
        ...
        <div class="post-meta">
          <span class="post-time">
            ...
            <time itemprop="dateCreated" datetime="2015-12-24T22:17:44+08:00" content="2015-12-24">
              2015-12-24
            </time>
          </span>
            ...
            <span class="post-category" >
              ...
              <span class="post-comments-count">
                &nbsp; | &nbsp;
                <a href="/2015/12/24/java00003/#comments" itemprop="discussionUrl">
                  <span class="post-comments-count ds-thread-count" data-thread-key="2015/12/24/java00003/" itemprop="commentsCount"></span>
                </a>
              </span>
             ...
             <span id="/2015/12/24/java00003/" class="leancloud_visitors" data-flag-title="如何成为一个牛掰的Java大神">
               &nbsp; | &nbsp;
               <span class="post-meta-item-icon">
                 <i class="fa fa-eye"></i>
               </span>
...
<div style="padding: 10px 0; margin: 20px auto; width: 90%; text-align: center">
  ...
  <div id="QR" style="display: none;">
    ...
    <footer class="post-footer">
        ...
        <div class="post-nav">
          <div class="post-nav-next post-nav-item">
              ...
              <a href="/2015/12/24/java00002/" rel="next" title="Java程序员的就业指导">
                <i class="fa fa-chevron-left"></i> Java程序员的就业指导
              </a>
          ...
          <div class="post-nav-prev post-nav-item">
              ...
              <a href="/2016/04/23/hello-world/" rel="prev" title="Hello World">
    ...
    <div class="post-spread">
        ...
        <div class="ds-share flat" data-thread-key="2015/12/24/java00003/"
     data-title="如何成为一个牛掰的Java大神"
     data-content=""
     data-url="http://www.dongxiaoxia.xyz/2015/12/24/java00003/">
  ...
  <div class="comments" id="comments">
      ...
      <div class="ds-thread" data-thread-key="2015/12/24/java00003/"
           data-title="如何成为一个牛掰的Java大神" data-url="http://www.dongxiaoxia.xyz/2015/12/24/java00003/">
      </div>
    ...
    <div class="sidebar-inner">
      ...
      <section class="site-overview sidebar-panel ">
        <div class="site-author motion-element" itemprop="author" itemscope itemtype="http://schema.org/Person">
          ...
          <p class="site-description motion-element" itemprop="description">怕什么真理无穷 进一寸有进一寸的欢喜</p>
        </div>
        ...
        <div class="links-of-author motion-element">
              ...
              <span class="links-of-author-item">
                <a href="https://www.zhihu.com/people/dong-xiao-xia" target="_blank" title="zhihu">
        ...
        <section class="post-toc-wrap motion-element sidebar-panel sidebar-panel-active">
          <div class="post-toc">
              ...
              <div class="post-toc-content"><ol class="nav"><li class="nav-item nav-level-1"><a class="nav-link" href="#一、基础篇"><span class="nav-number">1.</span> <span class="nav-text">一、基础篇</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#1-1_JVM"><span class="nav-number">1.1.</span> <span class="nav-text">1.1 JVM</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-1-_Java内存模型，Java内存管理，Java堆和栈，垃圾回收"><span class="nav-number">1.1.1.</span> <span class="nav-text">1.1.1. Java内存模型，Java内存管理，Java堆和栈，垃圾回收</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-2-_了解JVM各种参数及调优"><span class="nav-number">1.1.2.</span> <span class="nav-text">1.1.2. 了解JVM各种参数及调优</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-3-_学习使用Java工具"><span class="nav-number">1.1.3.</span> <span class="nav-text">1.1.3. 学习使用Java工具</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-4-_学习Java诊断工具"><span class="nav-number">1.1.4.</span> <span class="nav-text">1.1.4. 学习Java诊断工具</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-5-_自己编写各种outofmemory，stackoverflow程序"><span class="nav-number">1.1.5.</span> <span class="nav-text">1.1.5. 自己编写各种outofmemory，stackoverflow程序</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-6-_使用工具尝试解决以下问题，并写下总结"><span class="nav-number">1.1.6.</span> <span class="nav-text">1.1.6. 使用工具尝试解决以下问题，并写下总结</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-1-7-_参考资料"><span class="nav-number">1.1.7.</span> <span class="nav-text">1.1.7. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#1-2-_Java基础知识"><span class="nav-number">1.2.</span> <span class="nav-text">1.2. Java基础知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-1-_阅读源代码"><span class="nav-number">1.2.1.</span> <span class="nav-text">1.2.1. 阅读源代码</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-2-_熟悉Java中各种变量类型"><span class="nav-number">1.2.2.</span> <span class="nav-text">1.2.2. 熟悉Java中各种变量类型</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-3-_熟悉Java_String的使用，熟悉String的各种函数"><span class="nav-number">1.2.3.</span> <span class="nav-text">1.2.3. 熟悉Java String的使用，熟悉String的各种函数</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-4-_熟悉Java中各种关键字"><span class="nav-number">1.2.4.</span> <span class="nav-text">1.2.4. 熟悉Java中各种关键字</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-5-_学会使用List，Map，Stack，Queue，Set"><span class="nav-number">1.2.5.</span> <span class="nav-text">1.2.5. 学会使用List，Map，Stack，Queue，Set</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-6-_Java_IO&Java_NIO，并学会使用"><span class="nav-number">1.2.6.</span> <span class="nav-text">1.2.6. Java IO&Java NIO，并学会使用</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-7-_Java反射与javassist"><span class="nav-number">1.2.7.</span> <span class="nav-text">1.2.7. Java反射与javassist</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-8-_Java序列化"><span class="nav-number">1.2.8.</span> <span class="nav-text">1.2.8. Java序列化</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-9-_虚引用，弱引用，软引用"><span class="nav-number">1.2.9.</span> <span class="nav-text">1.2.9. 虚引用，弱引用，软引用</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-10-_熟悉Java系统属性"><span class="nav-number">1.2.10.</span> <span class="nav-text">1.2.10. 熟悉Java系统属性</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-11-_熟悉Annotation用法"><span class="nav-number">1.2.11.</span> <span class="nav-text">1.2.11. 熟悉Annotation用法</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-12-_JMS"><span class="nav-number">1.2.12.</span> <span class="nav-text">1.2.12. JMS</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-13-_JMX"><span class="nav-number">1.2.13.</span> <span class="nav-text">1.2.13. JMX</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-14-_泛型和继承，泛型和擦除"><span class="nav-number">1.2.14.</span> <span class="nav-text">1.2.14. 泛型和继承，泛型和擦除</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-15-_自动拆箱装箱与字节码"><span class="nav-number">1.2.15.</span> <span class="nav-text">1.2.15. 自动拆箱装箱与字节码</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-16-_实现Callback"><span class="nav-number">1.2.16.</span> <span class="nav-text">1.2.16. 实现Callback</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-17-_java-lang-Void类使用"><span class="nav-number">1.2.17.</span> <span class="nav-text">1.2.17. java.lang.Void类使用</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-18-_Java_Agent，premain函数"><span class="nav-number">1.2.18.</span> <span class="nav-text">1.2.18. Java Agent，premain函数</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-19-_单元测试"><span class="nav-number">1.2.19.</span> <span class="nav-text">1.2.19. 单元测试</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-20-_Java实现通过正则表达式提取一段文本中的电子邮件，并将@替换为#输出"><span class="nav-number">1.2.20.</span> <span class="nav-text">1.2.20. Java实现通过正则表达式提取一段文本中的电子邮件，并将@替换为#输出</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-21-_学习使用常用的Java工具库"><span class="nav-number">1.2.21.</span> <span class="nav-text">1.2.21. 学习使用常用的Java工具库</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-22-_什么是API&SPI"><span class="nav-number">1.2.22.</span> <span class="nav-text">1.2.22. 什么是API&SPI</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-2-23-_参考资料"><span class="nav-number">1.2.23.</span> <span class="nav-text">1.2.23. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#1-3-_Java并发编程"><span class="nav-number">1.3.</span> <span class="nav-text">1.3. Java并发编程</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-1-_阅读源代码，并学会使用"><span class="nav-number">1.3.1.</span> <span class="nav-text">1.3.1. 阅读源代码，并学会使用</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-2-_学习使用线程池，自己设计线程池需要注意什么"><span class="nav-number">1.3.2.</span> <span class="nav-text">1.3.2. 学习使用线程池，自己设计线程池需要注意什么</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-3-_锁"><span class="nav-number">1.3.3.</span> <span class="nav-text">1.3.3. 锁</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-4-_synchronized的作用是什么，synchronized和lock"><span class="nav-number">1.3.4.</span> <span class="nav-text">1.3.4. synchronized的作用是什么，synchronized和lock</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-5-_sleep和wait"><span class="nav-number">1.3.5.</span> <span class="nav-text">1.3.5. sleep和wait</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-6-_wait和notify"><span class="nav-number">1.3.6.</span> <span class="nav-text">1.3.6. wait和notify</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-7-_写一个死锁的程序"><span class="nav-number">1.3.7.</span> <span class="nav-text">1.3.7. 写一个死锁的程序</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-8-_什么是守护线程，守护线程和非守护线程的区别以及用法"><span class="nav-number">1.3.8.</span> <span class="nav-text">1.3.8. 什么是守护线程，守护线程和非守护线程的区别以及用法</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-9-_volatile关键字的理解"><span class="nav-number">1.3.9.</span> <span class="nav-text">1.3.9. volatile关键字的理解</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-10-_以下代码是不是线程安全？为什么？如果为count加上volatile修饰是否能够做到线程安全？你觉得该怎么做是线程安全的？"><span class="nav-number">1.3.10.</span> <span class="nav-text">1.3.10. 以下代码是不是线程安全？为什么？如果为count加上volatile修饰是否能够做到线程安全？你觉得该怎么做是线程安全的？</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-11-_解释一下下面两段代码的差别"><span class="nav-number">1.3.11.</span> <span class="nav-text">1.3.11. 解释一下下面两段代码的差别</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#1-3-12-_参考资料"><span class="nav-number">1.3.12.</span> <span class="nav-text">1.3.12. 参考资料</span></a></li></ol></li></ol></li><li class="nav-item nav-level-1"><a class="nav-link" href="#二、_进阶篇"><span class="nav-number">2.</span> <span class="nav-text">二、 进阶篇</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#2-1-_Java底层知识"><span class="nav-number">2.1.</span> <span class="nav-text">2.1. Java底层知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-1-_学习了解字节码、class文件格式"><span class="nav-number">2.1.1.</span> <span class="nav-text">2.1.1. 学习了解字节码、class文件格式</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-2-_写一个程序要求实现javap的功能（手工完成，不借助ASM等工具）"><span class="nav-number">2.1.2.</span> <span class="nav-text">2.1.2. 写一个程序要求实现javap的功能（手工完成，不借助ASM等工具）</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-3-_CPU缓存，L1，L2，L3和伪共享"><span class="nav-number">2.1.3.</span> <span class="nav-text">2.1.3. CPU缓存，L1，L2，L3和伪共享</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-4-_什么是尾递归"><span class="nav-number">2.1.4.</span> <span class="nav-text">2.1.4. 什么是尾递归</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-5-_熟悉位运算"><span class="nav-number">2.1.5.</span> <span class="nav-text">2.1.5. 熟悉位运算</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-1-6-_参考资料"><span class="nav-number">2.1.6.</span> <span class="nav-text">2.1.6. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#2-2-_设计模式"><span class="nav-number">2.2.</span> <span class="nav-text">2.2. 设计模式</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#2-2-1-_实现AOP"><span class="nav-number">2.2.1.</span> <span class="nav-text">2.2.1. 实现AOP</span></a><ol class="nav-child"><li class="nav-item nav-level-4"><a class="nav-link" href="#CGLIB和InvocationHandler的区别"><span class="nav-number">2.2.1.1.</span> <span class="nav-text">CGLIB和InvocationHandler的区别</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#动态代理模式"><span class="nav-number">2.2.1.2.</span> <span class="nav-text">动态代理模式</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#Javassist实现AOP"><span class="nav-number">2.2.1.3.</span> <span class="nav-text">Javassist实现AOP</span></a></li><li class="nav-item nav-level-4"><a class="nav-link" href="#ASM实现AOP"><span class="nav-number">2.2.1.4.</span> <span class="nav-text">ASM实现AOP</span></a></li></ol></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-2-2-_使用模板方法设计模式和策略设计模式实现IOC"><span class="nav-number">2.2.2.</span> <span class="nav-text">2.2.2. 使用模板方法设计模式和策略设计模式实现IOC</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-2-3-_不用synchronized和lock，实现线程安全的单例模式"><span class="nav-number">2.2.3.</span> <span class="nav-text">2.2.3. 不用synchronized和lock，实现线程安全的单例模式</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-2-4-_nio和reactor设计模式"><span class="nav-number">2.2.4.</span> <span class="nav-text">2.2.4. nio和reactor设计模式</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-2-5-_参考资料"><span class="nav-number">2.2.5.</span> <span class="nav-text">2.2.5. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#2-3-_网络编程知识"><span class="nav-number">2.3.</span> <span class="nav-text">2.3. 网络编程知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-1-_Java_RMI，Socket，HttpClient"><span class="nav-number">2.3.1.</span> <span class="nav-text">2.3.1. Java RMI，Socket，HttpClient</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-2-_用Java写一个简单的静态文件的HTTP服务器"><span class="nav-number">2.3.2.</span> <span class="nav-text">2.3.2. 用Java写一个简单的静态文件的HTTP服务器</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-3-_了解nginx和apache服务器的特性并搭建一个对应的服务器"><span class="nav-number">2.3.3.</span> <span class="nav-text">2.3.3. 了解nginx和apache服务器的特性并搭建一个对应的服务器</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-4-_用Java实现FTP、SMTP协议"><span class="nav-number">2.3.4.</span> <span class="nav-text">2.3.4. 用Java实现FTP、SMTP协议</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-5-_什么是CDN？如果实现？DNS起到什么作用？"><span class="nav-number">2.3.5.</span> <span class="nav-text">2.3.5. 什么是CDN？如果实现？DNS起到什么作用？</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-3-6-_参考资料"><span class="nav-number">2.3.6.</span> <span class="nav-text">2.3.6. 参考资料</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-4-_框架知识"><span class="nav-number">2.3.7.</span> <span class="nav-text">2.4. 框架知识</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#2-5-_应用服务器知识"><span class="nav-number">2.3.8.</span> <span class="nav-text">2.5. 应用服务器知识</span></a></li></ol></li></ol></li><li class="nav-item nav-level-1"><a class="nav-link" href="#三、_高级篇"><span class="nav-number">3.</span> <span class="nav-text">三、 高级篇</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#3-1-_编译原理知识"><span class="nav-number">3.1.</span> <span class="nav-text">3.1. 编译原理知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#3-1-1-_用Java实现以下表达式解析并返回结果（语法和Oracle中的select_sysdate-1_from_dual类似）"><span class="nav-number">3.1.1.</span> <span class="nav-text">3.1.1. 用Java实现以下表达式解析并返回结果（语法和Oracle中的select sysdate-1 from dual类似）</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-1-2-_实现对一个List通过DSL筛选"><span class="nav-number">3.1.2.</span> <span class="nav-text">3.1.2. 实现对一个List通过DSL筛选</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-1-3-_用Java实现以下程序（语法和变量作用域处理都和JavaScript类似）："><span class="nav-number">3.1.3.</span> <span class="nav-text">3.1.3. 用Java实现以下程序（语法和变量作用域处理都和JavaScript类似）：</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-1-4-_参考资料"><span class="nav-number">3.1.4.</span> <span class="nav-text">3.1.4. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#3-2-_操作系统知识"><span class="nav-number">3.2.</span> <span class="nav-text">3.2. 操作系统知识</span></a></li><li class="nav-item nav-level-2"><a class="nav-link" href="#3-3-_数据存储知识"><span class="nav-number">3.3.</span> <span class="nav-text">3.3. 数据存储知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#3-3-1-_关系型数据库"><span class="nav-number">3.3.1.</span> <span class="nav-text">3.3.1. 关系型数据库</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-3-2-_NoSQL"><span class="nav-number">3.3.2.</span> <span class="nav-text">3.3.2. NoSQL</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-3-3-_参考资料"><span class="nav-number">3.3.3.</span> <span class="nav-text">3.3.3. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#3-4-_大数据知识"><span class="nav-number">3.4.</span> <span class="nav-text">3.4. 大数据知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-1-_Zookeeper，在linux上部署zk"><span class="nav-number">3.4.1.</span> <span class="nav-text">3.4.1. Zookeeper，在linux上部署zk</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-2-_Solr，Lucene，ElasticSearch"><span class="nav-number">3.4.2.</span> <span class="nav-text">3.4.2. Solr，Lucene，ElasticSearch</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-3-_Storm，流式计算，了解Spark，S4"><span class="nav-number">3.4.3.</span> <span class="nav-text">3.4.3. Storm，流式计算，了解Spark，S4</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-4-_Hadoop，离线计算"><span class="nav-number">3.4.4.</span> <span class="nav-text">3.4.4. Hadoop，离线计算</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-5-_分布式日志收集flume，kafka，logstash"><span class="nav-number">3.4.5.</span> <span class="nav-text">3.4.5. 分布式日志收集flume，kafka，logstash</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-6-_数据挖掘，mahout"><span class="nav-number">3.4.6.</span> <span class="nav-text">3.4.6. 数据挖掘，mahout</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-4-7-_参考资料"><span class="nav-number">3.4.7.</span> <span class="nav-text">3.4.7. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#3-5-_网络安全知识"><span class="nav-number">3.5.</span> <span class="nav-text">3.5. 网络安全知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-1-_什么是DES、AES"><span class="nav-number">3.5.1.</span> <span class="nav-text">3.5.1. 什么是DES、AES</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-2-_什么是RSA、DSA"><span class="nav-number">3.5.2.</span> <span class="nav-text">3.5.2. 什么是RSA、DSA</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-3-_什么是MD5，SHA1"><span class="nav-number">3.5.3.</span> <span class="nav-text">3.5.3. 什么是MD5，SHA1</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-4-_什么是SSL、TLS，为什么HTTPS相对比较安全"><span class="nav-number">3.5.4.</span> <span class="nav-text">3.5.4. 什么是SSL、TLS，为什么HTTPS相对比较安全</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-5-_什么是中间人攻击、如果避免中间人攻击"><span class="nav-number">3.5.5.</span> <span class="nav-text">3.5.5. 什么是中间人攻击、如果避免中间人攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-6-_什么是DOS、DDOS、CC攻击"><span class="nav-number">3.5.6.</span> <span class="nav-text">3.5.6. 什么是DOS、DDOS、CC攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-7-_什么是CSRF攻击"><span class="nav-number">3.5.7.</span> <span class="nav-text">3.5.7. 什么是CSRF攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-8-_什么是CSS攻击"><span class="nav-number">3.5.8.</span> <span class="nav-text">3.5.8. 什么是CSS攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-9-_什么是SQL注入攻击"><span class="nav-number">3.5.9.</span> <span class="nav-text">3.5.9. 什么是SQL注入攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-10-_什么是Hash碰撞拒绝服务攻击"><span class="nav-number">3.5.10.</span> <span class="nav-text">3.5.10. 什么是Hash碰撞拒绝服务攻击</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-11-_了解并学习下面几种增强安全的技术"><span class="nav-number">3.5.11.</span> <span class="nav-text">3.5.11. 了解并学习下面几种增强安全的技术</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-12-_用openssl签一个证书部署到apache或nginx"><span class="nav-number">3.5.12.</span> <span class="nav-text">3.5.12. 用openssl签一个证书部署到apache或nginx</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#3-5-13-_参考资料"><span class="nav-number">3.5.13.</span> <span class="nav-text">3.5.13. 参考资料</span></a></li></ol></li></ol></li><li class="nav-item nav-level-1"><a class="nav-link" href="#四、_扩展篇"><span class="nav-number">4.</span> <span class="nav-text">四、 扩展篇</span></a><ol class="nav-child"><li class="nav-item nav-level-2"><a class="nav-link" href="#4-1-_相关知识"><span class="nav-number">4.1.</span> <span class="nav-text">4.1. 相关知识</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-1-_云计算，分布式，高可用，可扩展"><span class="nav-number">4.1.1.</span> <span class="nav-text">4.1.1. 云计算，分布式，高可用，可扩展</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-2-_虚拟化"><span class="nav-number">4.1.2.</span> <span class="nav-text">4.1.2. 虚拟化</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-3-_监控"><span class="nav-number">4.1.3.</span> <span class="nav-text">4.1.3. 监控</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-4-_负载均衡"><span class="nav-number">4.1.4.</span> <span class="nav-text">4.1.4. 负载均衡</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-5-_学习使用git"><span class="nav-number">4.1.5.</span> <span class="nav-text">4.1.5. 学习使用git</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-6-_学习使用maven"><span class="nav-number">4.1.6.</span> <span class="nav-text">4.1.6. 学习使用maven</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-7-_学习使用gradle"><span class="nav-number">4.1.7.</span> <span class="nav-text">4.1.7. 学习使用gradle</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-8-_学习一个小语种语言"><span class="nav-number">4.1.8.</span> <span class="nav-text">4.1.8. 学习一个小语种语言</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-9-_尝试了解编码的本质"><span class="nav-number">4.1.9.</span> <span class="nav-text">4.1.9. 尝试了解编码的本质</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-10-_尝试了解时间的本质"><span class="nav-number">4.1.10.</span> <span class="nav-text">4.1.10. 尝试了解时间的本质</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-1-11-_参考资料"><span class="nav-number">4.1.11.</span> <span class="nav-text">4.1.11. 参考资料</span></a></li></ol></li><li class="nav-item nav-level-2"><a class="nav-link" href="#4-2-_扩展学习"><span class="nav-number">4.2.</span> <span class="nav-text">4.2. 扩展学习</span></a><ol class="nav-child"><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-_JavaScript知识"><span class="nav-number">4.2.1.</span> <span class="nav-text">4.2.1. JavaScript知识</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-1-_什么是prototype"><span class="nav-number">4.2.2.</span> <span class="nav-text">4.2.1.1. 什么是prototype</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-2-_什么是闭包"><span class="nav-number">4.2.3.</span> <span class="nav-text">4.2.1.2. 什么是闭包</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-3-_了解并学习一个JS框架"><span class="nav-number">4.2.4.</span> <span class="nav-text">4.2.1.3. 了解并学习一个JS框架</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-4-_写一个Greasemonkey插件"><span class="nav-number">4.2.5.</span> <span class="nav-text">4.2.1.4. 写一个Greasemonkey插件</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-1-5-_学习node-js"><span class="nav-number">4.2.6.</span> <span class="nav-text">4.2.1.5. 学习node.js</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-2-_学习html5"><span class="nav-number">4.2.7.</span> <span class="nav-text">4.2.2. 学习html5</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#4-2-3-_参考资料"><span class="nav-number">4.2.8.</span> <span class="nav-text">4.2.3. 参考资料</span></a></li></ol></li></ol></li><li class="nav-item nav-level-1"><a class="nav-link" href="#五、_推荐书籍"><span class="nav-number">5.</span> <span class="nav-text">五、 推荐书籍</span></a></li></ol></div>
...
<script type="text/javascript" src="/js/src/post-details.js?v=5.0.1"></script>
  ...
  <script>AV.initialize("eNfNM1dz39uvzdbHhXaoGjMi-gzGzoHsz", "pbRRB2CfUCQ8d29wGvyI8Wpj");</script>
  <script>
